...
<head>
  ...
  <!-- summernote -->
  <link rel="stylesheet" href="{{asset('backend/plugins/summernote/summernote-bs4.')}}'">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('backend/dist/img/AdminLTELogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">FuturAFric</span>
    </a>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('download')}}">Telecharger le fichier Excel pour le remplir</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="post" action="{{route("excel.import")}}">
                            <div class="form-group">
                                <label for="mainmedia">Importer le fichier Excel</label>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="http://furturafric.com">FA IA</a>.</strong>
    All rights reserved.
